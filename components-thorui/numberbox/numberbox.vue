<template>
	<view class="tui-numberbox-class tui-numberbox">
		<view class="tui-numbox-icon tui-icon-reduce " :class="[disabled || min>=value?'tui-disabled':'']" @tap="reduce" :style="{color:'#bfbfbf',fontSize:iconSize+'rpx'}"></view>
		...
		<view class="tui-numbox-icon tui-icon-plus" :class="[disabled || value>=max?'tui-disabled':'']" @tap="plus" :style="{color:'#5b5e63',fontSize:iconSize+'rpx'}"></view>
	</view>
</template>
